...
/***/ (function(module, exports, __webpack_require__) {
	...
	var processorFilter = function processorFilter(request, response, next) {
	  try {
...
/***/ (function(module, exports) {
	...
	// File want to cache
	var urlsToCache = ['/', '/index.html', '/manifest.json', '/serviceworker-cache-polyfill.js', '/assets/img/blank-thumbnail.png', '/assets/img/favicon.png', '/assets/img/icon-48.png', '/assets/img/icon-96.png', '/assets/img/icon-128.png', '/assets/img/icon-144.png', '/assets/img/icon-152.png', '/assets/img/icon-196.png', '/assets/img/icon-384.png', '/main.js', '/dist/main.js', '/sw.js'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RouterX = __webpack_require__(7);

	riot.tag2('app-container', '<h4 class="offline-ready">Live</h4> <app-main></app-main> <app-navi></app-navi> <app-help></app-help>', 'body { margin: 0 }', '', function (opts) {
	  var self = this;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var riot = __webpack_require__(1);
	riot.tag2('app-counter', '<section> <h1> Hello Mr. Counter {cnt} </h1> <button onclick="{increment}"> Add </button> <button onclick="{decrement}"> Subtract </button> </section>', '', '', function (opts) {
		var self = this;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  init: function init(stores) {
	    var self = this;
	    var appName = 'app'; // @todo rm hardcoding
	    ...
	    self._.navTo = function (component, container, page) {
	      var options = {}; // @todo :: fill this in
	      if (!page || page === 'app') {
	        __webpack_require__(8)("./" + appName + '/' + appName + '-' + component + '.html');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var map = {
		"./app/app-container.html": 4,
		"./app/app-counter.html": 6,
		"./app/app-help.html": 9,
		"./app/app-main.html": 5,
		"./app/app-navi.html": 10,
		"./app/app-test.html": 11
	};
	  ...
	  self.on('mount', function () {
	    ...
	    self.root.querySelector('section#links').onclick = function (e) {
	      if (e.target.nodeName === 'A' && e.target.classList.contains('__trigger')) {
	        self._.navTo(e.target.getAttribute('x-to'), e.target.getAttribute('x-in'), 'app');
	      }
	    };
	  });
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var riot = __webpack_require__(1);
	riot.tag2('app-test', '<h1> Hello Mr. Test </h1>', '', '', function (opts) {});
