...
/***/ (function(module, exports) {
	...
	// File want to cache
	var urlsToCache = ['/', '/src/www/index.html', '/src/www/manifest.json', '/src/www/serviceworker-cache-polyfill.js', '/src/www/assets/img/blank-thumbnail.png', '/src/www/assets/img/favicon.png', '/src/www/assets/img/icon-48.png', '/src/www/assets/img/icon-96.png', '/src/www/assets/img/icon-128.png', '/src/www/assets/img/icon-144.png', '/src/www/assets/img/icon-152.png', '/src/www/assets/img/icon-196.png', '/src/www/assets/img/icon-384.png'
	// '/main.js'
	];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RouterX = __webpack_require__(6);
	...
	module.exports = {
	  ...
	  init: function init(stores) {
	    ...
	    self._.navTo = function (component, container, page) {
	      ...
	      if (!page || page === 'app') {
	        __webpack_require__(7)("./" + appName + '/' + appName + '-' + component + '.html');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var riot = __webpack_require__(1);
	riot.tag2('app-counter', '<h1> Hello Mr. Counter </h1>', '', '', function (opts) {});
